 ...
 */
namespace Tutorial\Long\Model\Post;
...
class DataProvider extends \Magento\Ui\DataProvider\ModifierPoolDataProvider
{
    ...
    public function getData()
    {
        ...
        $data = $this->dataPersistor->get('tutorial_long_post');
        if (!empty($data)) {
            ...
            $this->dataPersistor->clear('tutorial_long_post');
        }
    ...
    public function getMeta()
    {
        ...
        if (!$this->auth->isAllowed('Tutorial_Long::post_edit')) {
            $designMeta = [
                'design' => [
                    'arguments' => [
                        'data' => [
