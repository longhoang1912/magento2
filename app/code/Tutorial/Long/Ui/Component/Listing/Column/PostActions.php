 ...
 */
namespace Tutorial\Long\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'tutorial_long/post/edit';
    const CMS_URL_PATH_DELETE = 'tutorial_long/post/delete';
        ...
        if (isset($dataSource['data']['items'])) {
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                if (isset($item['post_id'])) {
                    ...
                    $item[$name]['delete'] = [
                        'href' => $this->urlBuilder->getUrl(self::CMS_URL_PATH_DELETE, ['post_id' => $item['post_id']]),
                        'label' => __('Delete'),
                        'confirm' => [
